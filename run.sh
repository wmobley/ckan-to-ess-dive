...
# Update these to point at the CKAN ➜ ESS-DIVE notebook repo.
export GIT_REPO_URL="https://github.com/wmobley/ckan-to-ess-dive.git"
export COOKBOOK_NAME="ckan-to-ess-dive"
export COOKBOOK_CONDA_ENV="ckan-essdive"
IS_GPU_JOB=false
